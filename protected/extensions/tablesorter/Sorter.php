...
class Sorter extends CWidget {
    ...
    public function genTable() {
        ...
        foreach ($datas as $data) {
            ...
            $view_url = Yii::app()->controller->createAbsoluteUrl($class . '/view', array('id' => $data->primaryKey));
            $edit_url = Yii::app()->controller->createAbsoluteUrl($class . '/update', array('id' => $data->primaryKey));
            $delete_url = Yii::app()->controller->createAbsoluteUrl($class . '/delete', array('id' => $data->primaryKey));
