...
//                                array('label' => 'บันทึกหัตถการ', 'url' => array('/canVisit/create')),
//                                array('label' => 'รายงาน', 'url' => array('/canVisit/report')),
                                array('label' => 'เกี่ยวกับระบบ', 'url' => array('/site/page', 'view' => 'about')),
//                                array('label' => 'ติดต่อผู้ดูแลระบบ', 'url' => array('/site/contact')),
                                array('url' => Yii::app()->getModule('duser')->loginUrl, 'label' => 'เข้าสู่ระบบ', 'visible' => Yii::app()->user->isGuest),
//                                array('url' => Yii::app()->getModule('duser')->profileUrl, 'label' =>'ข้อมูลส่วนตัว', 'visible' => !Yii::app()->user->isGuest),
                                array('url' => Yii::app()->getModule('duser')->logoutUrl, 'label' => 'ออกจากระบบ' . ' (' . Yii::app()->user->name . ')', 'visible' => !Yii::app()->user->isGuest),
                            ),
                        ));
                        ?>
            ...
            <div class="container">
                <div class="row">
                    <div id="footer-copyright" class="col-md-6">
                        Information and communication technology center of Khonkaen Hospital 
                    </div> <!-- /span6 -->
